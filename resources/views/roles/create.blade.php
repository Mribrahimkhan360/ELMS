<x-app-layout>
    ...
    <nav class="flex items-center gap-1.5 text-[11.5px] text-gray-400 mb-4">
        ...
        <span class="text-gray-600">Create Role</span>
    </nav>

    <div class="flex items-start justify-between mb-4">
        <div>
            <h1 class="text-[17px] font-semibold text-gray-900">Create Role</h1>
            <p class="text-[12px] text-gray-400 mt-0.5">Define a role and assign permissions</p>
        </div>
    </div>
            ...
            <div class="space-y-3">
                ...
                <div class="bg-white rounded-xl border border-black/[0.08] overflow-hidden">
                    <div class="px-5 py-3.5 border-b border-black/[0.07]">
                        ...
                        <p class="text-[11.5px] text-gray-400 mt-0.5">Basic information about this role</p>
                    </div>
                ...
                <div class="bg-white rounded-xl border border-black/[0.08] overflow-hidden">
                    ...
                    {{-- Footer --}}
                    <div class="flex items-center justify-end gap-2 px-5 py-3.5 border-t border-black/[0.07] bg-gray-50/60">
                        <a href=""
