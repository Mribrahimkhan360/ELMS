<x-app-layout>
    ...
    <div class="flex items-start justify-between mb-4">
        <div>
            ...
            <p class="text-[12px] text-gray-400 mt-0.5"> Update user details carefully to ensure accurate information and correct role assignment.</p>
        </div>
    </div>
            ...
            <div class="space-y-3">
               ...
               focus:border-indigo-400 focus:bg-white transition">
                                    ...
                                    @foreach($roles as $role)
                                        <option class="text-black" value="{{ $role->name }}" @selected($user->hasRole($role->name))>
                                            {{ $role->name }} </option>
                                    @endforeach
                                </select>
                            </div>
