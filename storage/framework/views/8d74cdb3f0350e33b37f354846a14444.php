                ...
                <div class="bg-white rounded-xl border border-black/[0.08] overflow-hidden">
                    ...
                    <div class="divide-y divide-black/[0.05]">
                        ...
                        <div class="flex items-center justify-between px-4 py-2.5">
                            ...
                            <span class="text-[12px] font-semibold text-gray-700"> <?php echo e($userCount); ?></span>
                        </div>
                        <div class="flex items-center justify-between px-4 py-2.5">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ELMS\resources\views/permissions/create.blade.php ENDPATH**/ ?>