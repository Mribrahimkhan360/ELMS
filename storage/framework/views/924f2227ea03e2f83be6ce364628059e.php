...
<?php $component->withAttributes([]); ?>
    ...
    <div class="flex items-start justify-between mb-4">
        <div>
            <h1 class="text-[17px] font-semibold text-gray-900">Update Leave</h1>
    ...
    <form method="POST" action="<?php echo e(route('leave.update', $leave)); ?>">
        <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-xl border border-black/[0.08] overflow-hidden">
                    ...
                    <div class="px-5 py-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="form_date"
                                       value="<?php echo e(old('form_date',$leave->form_date)); ?>"
                            ...
                            <div>
                                ...
                                <select name="leave_type" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-3 py-2 text-[13px]">
                                    <option value="">-- Select Leave Type --</option>

                                    <option value="sick" <?php echo e(old('leave_type', $leave->leave_type) == 'sick' ? 'selected' : ''); ?>>
                                        Sick
                                    </option>

                                    <option value="casual" <?php echo e(old('leave_type', $leave->leave_type) == 'casual' ? 'selected' : ''); ?>>
                                        Casual
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            ><?php echo e(old('reason', $leave->reason)); ?></textarea>
                        </div>
                    </div>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\ELMS\resources\views/leave/edit.blade.php ENDPATH**/ ?>